...
#define TRUE_X_MAX   160

#define X_MAX_OUT 211
#define Y_MAX_OUT 311
//定义采样点数
#define dot_num 20
//定义中线起始和终止位置
...
;
extern  uint8   date[X_MAX][Y_MAX];
extern uint16 center_dot,center_change;
extern int16 center[150][2];
...
uint16  change_get(uint16 line[300][2],uint16 dot_n);
