...
void show_image(uint16 x,uint16 y,uint16 hang,uint16 lie,uint8  date1[X_MAX][Y_MAX])
 {
     uint16 i,j;
     for(i=0;i<hang;i++)
     {	
...
void show_dot_change2(uint16 T[][2], uint16 line_Num, uint16 line_color)
{
	uint16 i, j;
	for (j = 0; j<3; j++)
	{
