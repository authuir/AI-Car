...
#if 0       //寄存器位操作，有两种方法，前者效率更高，因而此处使用第一种
#define PT(X,n,REG)         BITBAND_REG(FPT##X##_BASE_PTR->##REG,n)              //位操作 （KL 已经不支持 此方法，改成 BME ）
#else
#define PT(X,n,REG)         (((Dtype *)(&(FPT##X##_BASE_PTR->##REG)))->b##n)
#endif
