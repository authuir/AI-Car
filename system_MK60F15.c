...
void SystemInit (void) {
  ...
  SCB_CPACR |= ((3UL << 10*2) | (3UL << 11*2));    /* set CP10, CP11 Full Access */
  ...
  SIM_SOPT2 &= (uint32_t)~0x00030000UL; /* Select FLL as a clock source for various peripherals */
  ...
  MCG_C11 = (uint8_t)0x00U;            /* 3 */
  /* MCG_C12: LOLIE1=0,??=0,CME2=0,VDIV1=0 */
  MCG_C12 = (uint8_t)0x00U;            /* 3 */
  ...
  SIM_CLKDIV1 = (uint32_t)0x00250000UL; /* Update system prescalers */
  ...
  /* MCG_C6: LOLIE0=0,PLLS=0,CME0=0,VDIV0=30 */
  MCG_C6 = (uint8_t)0x0EU;
  /* MCG_C11: PLLREFSEL1=0,PLLCLKEN1=0,PLLSTEN1=0,PLLCS=0,??=0,PRDIV1=0 */
  MCG_C11 = (uint8_t)0x00U;
  /* MCG_C12: LOLIE1=0,??=0,CME2=0,VDIV1=0 */
...
void SystemCoreClockUpdate (void) {
  ...
  if ((MCG_C1 & MCG_C1_CLKS_MASK) == 0x0u) {
    ...
    if ((MCG_C6 & MCG_C6_PLLS_MASK) == 0x0u) {
      ...
      if ((MCG_C1 & MCG_C1_IREFS_MASK) == 0x0u) {
        ...
        if ((MCG_C7 & MCG_C7_OSCSEL_MASK) == 0x0u) {
          MCGOUTClock = CPU_XTAL0_CLK_HZ;                                       /* System oscillator 0 drives MCG clock */
        } else { /* (!((MCG_C7 & MCG_C7_OSCSEL_MASK) == 0x0u)) */
          MCGOUTClock = CPU_XTAL32k_CLK_HZ;                                    /* RTC 32 kHz oscillator drives MCG clock */
        } /* (!((MCG_C7 & MCG_C7_OSCSEL_MASK) == 0x0u)) */
        ...
        } /* ((MCG_C2 & MCG_C2_RANGE0_MASK) != 0x0u) */
      } else { /* (!((MCG_C1 & MCG_C1_IREFS_MASK) == 0x0u)) */
        MCGOUTClock = CPU_INT_SLOW_CLK_HZ;                                     /* The slow internal reference clock is selected */
      } /* (!((MCG_C1 & MCG_C1_IREFS_MASK) == 0x0u)) */
  ...
  } else { /* (!((MCG_C1 & MCG_C1_CLKS_MASK) == 0x80u)) */
    /* Reserved value */
    return;
  } /* (!((MCG_C1 & MCG_C1_CLKS_MASK) == 0x80u)) */
