...
#define Y_WIDTH 64
    ...
    #define LCD_D0_PORT_PIN      8
    //D1端口选择
    #define LCD_D1_PORT          PORTD
    #define LCD_D1_PORT_PIN      9
    //reset端口选择
    #define LCD_RESET_PORT       PORTD
    #define LCD_RESET_PORT_PIN   10
    //DC端口选择
    #define LCD_DC_PORT          PORTD
    #define LCD_DC_PORT_PIN      11
