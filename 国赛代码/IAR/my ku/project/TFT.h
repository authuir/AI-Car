...
void show_image(uint16 x,uint16 y,uint16 hang,uint16 lie,uint8  date1[X_MAX][Y_MAX+15]);
void show_line(float line_k,float line_b);
void show_dot_change(uint16 T[][2], uint16 line_Num, uint16 line_color);
void show_dot_change2(int16 T[][2], uint16 line_Num, uint16 line_color);
#endif