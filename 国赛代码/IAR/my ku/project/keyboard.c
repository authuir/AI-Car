...
uint8 IS_Deal_PD = 0;
extern float middle_Ap;
uint8  Ready_Stop_Time = 10;
uint8  mode_select=0;
...
void key_run(uint8 key_num)
{
	...
	else if(key_num==Key1)
	{
		...
		case 7:middle_Ap+=0.1;display(13,7,middle_Ap);break;
		}
	}
...
void ChooseGear()
{
	...
	while(1){
		...
		if ( KeyVal == Key3) {
			...
			if (Gear == 0)
			{     
				driver=70;middle_p=5;k_p=400;sub_a=1.02;sub_p=1;for_ward=70;sub_slow=0.2;middle_d=5;mode_select=1;
			}
			else if (Gear == 1)
			{
				driver=80;middle_p=5;k_p=400;sub_a=1.2;sub_p=1;for_ward=70;sub_slow=0.4;middle_d=5;mode_select=2;
			}
			else if (Gear == 2)
			{
				driver=90;middle_p=5;k_p=400;sub_a=1.2;sub_p=1;for_ward=80;sub_slow=0.6;mode_select=3;
			}
			else if (Gear == 3)
			{
				driver=100;
				...
				case Key1: 
					{
						...
						case 2:Ready_Stop_Time++;
								if (Ready_Stop_Time<0) 
									Ready_Stop_Time = 0;
								if (Ready_Stop_Time>28) 
									Ready_Stop_Time = 28;
								display(13,2,Ready_Stop_Time);break;
						case 3:for_ward+=3;display(13,3,for_ward);break;
						case 4:middle_d+=0.2;display(13,4,middle_d);break;
						case 5:sub_slow+=0.1;display(13,5,sub_slow);break;
						}
					}
					break;
				case Key2:
					{
						...
						case 2:	Ready_Stop_Time--;
								...
								if (Ready_Stop_Time>28) 
									Ready_Stop_Time = 28;
									Ready_Stop_Time;display(13,2,Ready_Stop_Time);
								break;
						case 3:for_ward-=3;display(13,3,for_ward);break;
						case 4:middle_d-=0.2;display(13,4,middle_d);break;
						case 5:sub_slow-=0.1;display(13,5,sub_slow);break;
...
void ChooseAdjust()
{
	...
	middle_d=7;
    driver=80;middle_p=3.7;k_p=400;sub_a=1.2;sub_p=1;for_ward=50;sub_slow=0.2;
